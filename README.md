...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5fjxsg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5fjxsg.containers.anotherwebservice.com/
...
```
git clone git@github.com:810810810/container-5fjxsg.git
cd container-5fjxsg
```
...
```
docker attach container-5fjxsg
```
